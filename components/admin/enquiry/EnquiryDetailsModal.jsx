...
const statusOptions = ["new", "contacted", "visited", "closed", "rejected"];

const EnquiryDetailsModal = ({ enquiry, show, onClose, onUpdated }) => {
  // ===============================
  // STATE
  // ===============================
  ...
  const handleAddNote = async () => {
    ...
    try {
      ...
      await API.post(`/enquiries/${enquiry._id}/notes`, {
        text: note,
      });
        ...
        <div className="modal-content border-0 shadow-lg">
          ...
          <div className="modal-header">
            <div>
              ...
              <small className="text-muted">Lead management panel</small>
            </div>
            ...
            <div className="row g-4">
              ...
              <div className="col-md-6">
                ...
                <div className="card border-0 bg-light p-3 mt-3">
                  ...
                  <p>
                    <strong>Title:</strong> {enquiry.property?.title || "-"}
                  </p>
              ...
              <div className="col-md-6">
                {/* Lead Management */}
                <div className="card border-0 bg-light p-3">
                  <h6 className="fw-bold mb-3">Lead Management</h6>
                ...
                {/* Notes */}
                <div className="card border-0 bg-light p-3 mt-3">
                  <NotesTimeline notes={enquiry?.notes} />
